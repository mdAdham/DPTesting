...
function NetCard({plan, quality, price, video_sound_quality, resolution, special_audio, supported_device, concurrent_watching, download_device}) {
    return (
        <div className={plan == "Basic" ? "net-card most-popular" : "net-card"}>
            <div
                className="popular"
                style={{ display: plan === "Basic" ? "block" : "none" }}>
                <h5>Most Popular</h5>
            </div>
            <div className={`topic ${plan}`}>
                <h2>{plan}</h2>
                <h3>{quality}</h3>
            </div>
            <div className="details">
                ...
                <div className="points"
                    style={{display: plan === "Premium" ? "block": "none"}}>
                    <p>Special audio (immersive sound)</p>
                    <h4>{special_audio}</h4>
                </div>
                ...
                <div className="points">
                    <p>Supported devices</p>
                    <h4>{supported_device}</h4>
                </div>
                <hr />
                <div className="points">
                    <p>Devices your household can watch at the same time</p>
                    <h4>{concurrent_watching}</h4>
                </div>
                <div className="points">
                    <p>Download devices</p>
                    <h4>{download_device}</h4>
                </div>
            </div>
        </div>
    );
